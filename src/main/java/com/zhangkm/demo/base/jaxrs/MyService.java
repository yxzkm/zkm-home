package com.zhangkm.demo.base.jaxrs;
...
public class MyService {
	...
	final String XMLNS_NAMESPACE = "http://localhost:9999/aaaaaaaaaaaarest1";
	...
	public String getHelloWorldHtml() {
		...
		System.out.println("HHHHHHHHHHHHHHTTTTTTTTTTTTTTTTMMMMMMMMMMMMMMMMMMMMLLLLLLLLLL");
		String result = ""
				+ "\n<!DOCTYPE html>"
				+ "\n<html>"
				+ "\n<head>"
				+ "\n<meta charset=\"utf-8\">"
				+ "\n<title>正义网2016第一期通讯员培训班</title>"
