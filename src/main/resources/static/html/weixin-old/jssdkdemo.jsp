...
<div class="wxapi_container">
    <div class="lbox_close wxapi_form">
      ...
      <span class="desc">上传图片接口完整版（包含选取、上传微信服务器、下拉到我的服务器）</span>
...
<script>
var appid = '${appid}';
var signUrl = 'http://zhangkm.com/weixin/jssdk/'+appid+'/sign';
var dragFileBackFromWeixinUrl = 'http://zhangkm.com/weixin/jssdk/'+appid+'/dragFileBackFromWeixin';
var temp = {};
...
<script src="/js/demo.js?version=123"></script>
</html>
